...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 30 jan. 2018 à 12:42
...
--
ALTER TABLE `t_articles`
  MODIFY `idT_ARTICLES` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
